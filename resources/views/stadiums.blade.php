        ...
        <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="item">
                                {!! Form::open(['route' => ['stadiums'],'method'=>'GET','class'=>'form-inline row align-items-center']) !!}
            ...
            <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('stadium',$stadium->slug) }}" class="item">
                                <span class=""><img class="rounded" src="{{env('APP_URL')}}:8000/storage/stadiums/{{$stadium->picture}}" height="100px" alt="{{$stadium->caption}}"></span>
                                <span class="name">{{$stadium->caption}}</span>
                            </a>
                        </div>
                        @endforeach
                    </div>
