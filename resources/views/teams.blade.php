            ...
            <div class="part-list">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="item">
                                {!! Form::open(['route' => ['teams'],'method'=>'GET','class'=>'form-inline row align-items-center']) !!}
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('team',$team->slug) }}" class="item">
                                <span class="logo"><img src="{{env('APP_URL')}}:8000/storage/teams/{{$team->logo}}" height="80" alt="team-logo"></span>
                                <span class="name">{{$team->caption}}</span>
                            </a>
                        </div>
                        @endforeach
                    </div>
